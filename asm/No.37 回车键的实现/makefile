...
ckernel.o : write_vga_desktop_win.o win_sheet.o mem_util.o timer.o global_define.o multi_task.o
	ld -m elf_i386 -r write_vga_desktop_win.o mem_util.o win_sheet.o timer.o global_define.o multi_task.o -o ckernel.o
write_vga_desktop_win.o : write_vga_desktop_win.c win_sheet.c win_sheet.h mem_util.c mem_util.h timer.c timer.h global_define.c global_define.o multi_task.c multi_task.h
...
multi_task.o : multi_task.c multi_task.h
	gcc -m32 -fno-pic -fno-asynchronous-unwind-tables -s -c multi_task.c -o multi_task.o
all : ckernel.asm
	...
	@echo "镜像已移动到Bochs根目下"
	@rm ckernel.o write_vga_desktop_win.o win_sheet.o mem_util.o timer.o global_define.o multi_task.o
clean:
