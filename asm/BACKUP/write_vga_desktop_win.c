...
void CMain(void) {
    ...
    sheet_level_updown(shtctl, sht_back, 0);
  
    sheet_level_updown(shtctl, sht_mouse, 100);
...
//switch task
    ...
    //set_segmdesc(gdt + 8, 103, (int)&task_a->tss, AR_TSS32);
    
    //set_segmdesc(gdt + 9, 103, (int) &task_b->tss, AR_TSS32);
...
struct SHEET*  message_box(struct SHTCTL *shtctl,  char *title) {
    ...
    sheet_level_updown(shtctl, sht_win, 2);
